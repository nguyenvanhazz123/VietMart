                            ...
                            <div class="electronics-pro-active owl-carousel">
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\5.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\6.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\8.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\9.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\11.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\12.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\13.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\14.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                            ...
                            <div class="electronics-pro-active owl-carousel">
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\42.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\43.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\40.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\41.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\39.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\38.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                ...
                                                <img class="secondary-img" src="{{asset('img\products\37.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\35.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\36.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\34.jpg')}}" alt="single-product">
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\32.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\33.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                            ...
                            <div class="electronics-pro-active owl-carousel">
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\43.jpg')}}" alt="single-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                ...
                                                <img class="secondary-img" src="{{asset('img\products\39.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\9.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\10.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                            ...
                            <div class="electronics-pro-active owl-carousel">
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\19.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\20.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                ...
                                                <img class="secondary-img" src="{{asset('img\products\21.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\21.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\22.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\24.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\25.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="double-product">
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\26.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\27.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="product.html">
                                                <img class="primary-img" src="{{asset('img\products\28.jpg')}}" alt="single-product">
                                                <img class="secondary-img" src="{{asset('img\products\29.jpg')}}" alt="single-product">
                                            </a>
                                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                        </div>
                                        <!-- Product Image End -->
